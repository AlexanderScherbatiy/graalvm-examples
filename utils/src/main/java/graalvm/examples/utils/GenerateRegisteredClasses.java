...
public class GenerateRegisteredClasses {
    ...
    public static void generateRuntimeAccess(String file, String prefix) throws Exception {

        List<AcessClass> jniClasses = parse(file);
